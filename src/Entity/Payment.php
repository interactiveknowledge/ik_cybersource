 ...
 *     "list_builder" = "Drupal\ik_cybersource\PaymentListBuilder",
 *     "views_data" = "Drupal\views\EntityViewsData",
 *     "access" = "Drupal\ik_cybersource\PaymentAccessControlHandler",
 *     "form" = {
 *       "add" = "Drupal\ik_cybersource\Form\PaymentForm",
 *       "edit" = "Drupal\ik_cybersource\Form\PaymentForm",
 ...
 *   },
 *   links = {
 *     "add-form" = "/admin/content/cybersource/payment/add",
 *     "canonical" = "/payment/{payment}",
 *     "edit-form" = "/admin/content/cybersource/payment/{payment}/edit",
 *     "delete-form" = "/admin/content/cybersource/payment/{payment}/delete"
 *   },
...
class Payment extends ContentEntityBase implements PaymentInterface {
  ...
  public function getWebformSubmission(): WebformSubmissionInterface {
    return $this->get('submission')->entity;
  }
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['submission'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('Submission data provided by the user via Cybersource payment webform.'))
